      ...
      <header className={"d-flex align-items-center justify-content-center"}>
          <aside>
              <ul>
                  ...
                  <li data-aos={"fade-left"} data-aos-delay={"200"}><a href="https://www.instagram.com/jacob_meyer115/" target={"_blank"} rel="noreferrer"><i className="fa-2x fa-brands fa-instagram fa-fw"></i></a></li>
