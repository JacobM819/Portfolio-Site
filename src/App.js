      ...
      <header className={"d-flex align-items-center justify-content-center"}>
          <aside>
              <ul>
                  ...
                  <li data-aos={"fade-left"} data-aos-delay={"300"}><a href="https://www.instagram.com/jacob_meyer115/" target={"_blank"} rel="noreferrer"><i className="fa-2x fa-brands fa-instagram fa-fw"></i></a></li>
          ...
          <div className={"row align-items-center"}>
              <div className={"col-lg-8"}>
                  ...
                  <h2 style={{fontSize: "clamp(1.1rem, 1.5vw, 1.7rem)"}} className={"text-white mt-3"} data-aos={"fade-up"} data-aos-delay={"1300"} data-aos-once="true">
