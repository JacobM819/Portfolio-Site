      ...
      <header className={"d-flex align-items-center justify-content-center"}>
          <aside>
              <ul>
                  ...
                  <li data-aos={"fade-left"} data-aos-delay={"200"}><a href="https://www.instagram.com/jacob_meyer115/" target={"_blank"} rel="noreferrer"><i className="fa-2x fa-brands fa-instagram fa-fw"></i></a></span></li>
                  <li data-aos={"fade-left"} data-aos-delay={"300"}><a href="mailto:jakem3350@gmail.com" target="_blank" rel="noreferrer"><i className="fa-2x fa-light fa-envelope fa-fw"></i></a></li>
              </ul>
          </aside>
          <div className={"row align-items-center"}>
              <div className={"col-lg-8"}>
                  <h3 style={{fontSize: "clamp(1.4rem, 2.0vw, 1.9rem"}} className={"code mb-0"} data-aos={"fade-up"} data-aos-once="true">
