          ...
          <div className={"grid row ml-1"}>
              ...
              <div className={"row justify-content-center"}>
                <div className={"col-3"}>
                  <div className={"table-block"}>
                    <span className={"grid-helper"}></span>
            ...
            <div className={"col-12 col-md-6 mr-0"}>
              <div className={"skills-card"} style={{ padding: "30px" }}>
                <p>
                  I have worked with and created projects using some of the most
                  popular and in-demand languages. Many of the web apps that I
                  have created recently use a combination of React.js, PHP,
                  Node.js, and Javascript.
                </p>
                <p>
                  I am proficient with functional programming and
                  object-oriented design patterns, as I have worked in languages
                  like Python and Java in some of my personal projects.
                </p>
                <p className={"mb-0"}>
                  One of my favorite parts about software engineering is
                  learning new languages. I am always learning a new language,
                  and I am currently working on C++.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div className={"grid row ml-1"}>
          <div className={"col-lg-6"}>
            <div className={"skills-card"} style={{ padding: "30px" }}>
              <p>
                Throughout my years in creating software, I have had the
                opportunity to explore a variety of tools that are used in
                modern-day applications.
              </p>
              <p>
                I have worked on many projects using Git and Github, while also
                hosting some applications using an Ubuntu Linux server that I
                have at home. In many of my applications that require a
                database, I typically use PHPmyAdmin as a front end for MySQL.
              </p>
              <p className={"mb-0"}>
                Currently, I am focused on learning Amazon Web Services (AWS),
                as I know how big of a role cloud computing plays in today's
                tech industry.
              </p>
            </div>
          </div>
