...
export default function Project(props) {
  ...
  return (
    <>
      <div
        className={"card"}
        style={{ width: "21vw", maxWidth: "300px", border: "none" }}
        data-toggle="modal"
      ...
      >
        ...
        >
          ...
          <div className={"overlay"}>
            ...
            <FontAwesomeIcon icon={faMagnifyingGlassPlus} className="fa-size proj-icon" />
          </div>
        </button>
        <div className={"card-body proj-body position-relative"}>
          <h5 className={"card-title"}>{props.title}</h5>
          <p className={"card-text code"} style={{ color: "#bebebe" }}>
            {props.langs}
          </p>
          <div
          ...
          >
            <a
              ...
              rel={"noreferrer"}
            >
              <i id={"git-link"} className="fab fa-github"></i>
            </a>
