    ...
    <section id={"projects"} className={"proj-container"}>
      <div className={"center-mobile d-flex gap-5"}>
        <h1
          ...
          data-aos-once={"true"}
        >
          <span className={"code"}>03.</span> My Projects
        </h1>
        <div className={"hide-mobile"} style={{ marginTop: "1.5rem" }}>
          <h6 className={"code type"}>
      ...
      <div className={"row mb-4"} data-aos={"fade-up"} data-aos-once={"true"}>
        <div className={"col-sm-12 col-lg-4"}>
          <Project
            ...
            descr={
              "This is the site that you are on right now! It is digital portfolio with the purpose" +
        ...
        <div className={"col-sm-12 col-lg-4"}>
          <Project
            ...
            descr={
              "A desktop application for automatically opening up Zoom calls when they are scheduled" +
        ...
        <div className={"col-sm-12 col-lg-4"}>
          <Project
            title={"ZuzaPlan"}
            descr={
              "ZuzaPlan is a desktop event management application that makes it easy for a busy person to stay" +
      ...
      <div className={"row mb-4"} data-aos={"fade-up"} data-aos-once={"true"}>
        <div className={"col"}>
          <Project
            ...
            descr={
              "Primo is an online store that I created for small businesses to purchase and " +
        ...
        <div className={"col"}>
          <Project
            ...
            descr={
              "This application is designed to help students create their upcoming schedules for school." +
        ...
        <div className={"col"}>
          <Project
            ...
            descr={
              "In high school, I created a website to show news and events of my school district." +
